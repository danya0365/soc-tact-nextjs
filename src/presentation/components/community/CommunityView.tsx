        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center mb-8">
            ...
            <p className="text-xl opacity-90">
              ชุมชนคอมมูนิตี้ฟุตบอล - เชื่อมต่อแฟนบอลทั่วโลก
            </p>
          </div>
                  ...
                  >
                    <div className="p-6">
                      ...
                      <Link href={`/community/posts/${post.id}`}>
                        <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2 hover:text-green-600 transition-colors cursor-pointer">
                          {post.title}
                        </h3>
                      </Link>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400 mb-4">
                            <div>
                              👥 {formatNumber(group.stats.members)} สมาชิก
                            </div>
                            <div>
                              📝 {formatNumber(group.stats.posts)} โพสต์
                            </div>
                          ...
                          <div className="flex gap-2">
                            <button
                              onClick={() =>
                                actions.openJoinGroupModal(group.id)
                              }
                            ...
                            <Link
                              ...
                              className="bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 px-6 py-2 rounded-lg"
                            >
                              ดูกลุ่ม
                            </Link>
                          </div>
                ...
                {upcomingEvents.map((event) => (
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <button
                        onClick={() => actions.rsvpEvent(event.id)}
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400 mb-3">
                      ...
                      <div className="ml-auto">
                        {formatDate(disc.lastActivityDate)}
                      </div>
                    </div>
                    <div className="flex flex-wrap gap-2">
                      {disc.tags.map((tag) => (
                      ...
                      {poll.options.map((option) => (
                        ...
                        >
                          ...
                          <div className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                            {formatNumber(option.votes)} โหวต
                          </div>
                        </button>
                      ))}
                    </div>
                    <div className="text-sm text-gray-600 dark:text-gray-400">
                      ทั้งหมด {formatNumber(poll.totalVotes)} โหวต • สิ้นสุด{" "}
                      {new Date(poll.endDate).toLocaleDateString("th-TH")}
                    </div>
                  </div>
                ))}
              </>
                  ...
                  {topMembers.slice(0, 5).map((item) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-sm text-gray-500 dark:text-gray-400">
                          {formatNumber(item.member.reputation)} คะแนน
                        </div>
                      </div>
                    </div>
                  ))}
