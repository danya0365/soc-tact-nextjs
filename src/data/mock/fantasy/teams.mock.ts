...
export const RIVAL_TEAMS: FantasyTeam[] = [
  {
    ...
    squad: [
      { playerId: 'gk2', position: 'GK', isCaptain: false, isViceCaptain: false, isStarting: true },
      { playerId: 'def2', position: 'DEF', isCaptain: false, isViceCaptain: false, isStarting: true },
      { playerId: 'def3', position: 'DEF', isCaptain: false, isViceCaptain: false, isStarting: true },
      { playerId: 'def4', position: 'DEF', isCaptain: false, isViceCaptain: false, isStarting: true },
      { playerId: 'def5', position: 'DEF', isCaptain: false, isViceCaptain: false, isStarting: true },
      { playerId: 'mid2', position: 'MID', isCaptain: false, isViceCaptain: true, isStarting: true },
      { playerId: 'mid3', position: 'MID', isCaptain: false, isViceCaptain: false, isStarting: true },
      { playerId: 'mid4', position: 'MID', isCaptain: false, isViceCaptain: false, isStarting: true },
      { playerId: 'fwd1', position: 'FWD', isCaptain: true, isViceCaptain: false, isStarting: true },
      { playerId: 'fwd2', position: 'FWD', isCaptain: false, isViceCaptain: false, isStarting: true },
      { playerId: 'fwd4', position: 'FWD', isCaptain: false, isViceCaptain: false, isStarting: true },
      { playerId: 'gk1', position: 'GK', isCaptain: false, isViceCaptain: false, isStarting: false, benchOrder: 1 },
      { playerId: 'def1', position: 'DEF', isCaptain: false, isViceCaptain: false, isStarting: false, benchOrder: 2 },
      { playerId: 'mid1', position: 'MID', isCaptain: false, isViceCaptain: false, isStarting: false, benchOrder: 3 },
      { playerId: 'fwd3', position: 'FWD', isCaptain: false, isViceCaptain: false, isStarting: false, benchOrder: 4 },
    ],
    gameweekHistory: [],
  },
  {
